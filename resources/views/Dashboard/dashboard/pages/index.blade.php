            ...
            <div class="card radius-15">
                <div class="card-body">
                    <div class="card-title">
                        <h4 class="mb-0">{{ __('Pages') }}
                            @if(PerUser('pages.create'))
                        <a href="{{ route('pages.create') }}" style="float:right;" class="btn btn-primary ml-auto"><i class="fadeIn animated bx bx-message-square-add"></i> {{ __('Create :type',['type'=>__('Page')]) }}</a>
                    @endif
                        </h4>
