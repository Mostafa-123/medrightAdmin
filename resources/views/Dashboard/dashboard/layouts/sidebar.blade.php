        ...
        <div class="content-side">
            <ul class="nav-main">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link" href="{{ route('redirect') }}">
                ...
                @if(PerUser('requests.index'))

                <li class="nav-main-heading">Requests</li>
                @if(PerUser('levels.index'))
                <li class="nav-main-item">
                    <a class="nav-main-link" href="{{ route('levels.index') }}">
                        <i class="nav-main-link-icon fa fa-elevator"></i>
                        <span class="nav-main-link-name">Levels</span>
                    </a>
                </li>
                @endif
                @if(PerUser('positions.index'))
                <li class="nav-main-item">
                    <a class="nav-main-link" href="{{ route('positions.index') }}">
                        <i class="nav-main-link-icon fa fa-rug"></i>
                        <span class="nav-main-link-name">Postions</span>
                    </a>
                </li>
                @endif
                @if(PerUser('requests.index'))
                <li class="nav-main-item">
                    <a class="nav-main-link" href="{{ route('requests.index') }}">
                        <i class="nav-main-link-icon fa fa-signs-post"></i>
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item open">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link active" href="be_pages_sidebar_mini_nav.html">
