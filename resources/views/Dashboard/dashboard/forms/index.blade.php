            ...
            <div class="card radius-15">
                <div class="card-body">
                    <div class="card-title">
                        <h4 class="mb-0">{{ __('Forms') }}
                            @if(PerUser('forms.create'))
                        <a href="{{ route('forms.create') }}" style="float:right;" class="btn btn-primary ml-auto"><i class="fadeIn animated bx bx-message-square-add"></i> {{ __('Create :type',['type'=>__('Form')]) }}</a>
                    @endif
                        </h4>
