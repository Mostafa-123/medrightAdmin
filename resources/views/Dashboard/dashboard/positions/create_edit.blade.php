...
@endsection
@section('title')
{{ (isset($position))?__('Edit'):__('Create') }}
@endsection
@section('content')
        ...
        <div class="card radius-15 border-lg-top-primary">
            <div class="card-body">
                <div class="card-title">
                    <h4 class="mb-0">{{ (isset($position))?__('Edit :type',['type'=>$position->name]):__('Create') }}</h4>
                </div>
                <hr>
                <form method="POST"
                    action="{{ isset($position)?route('positions.update',['position'=>$position]):route('positions.store') }}"
                    ...
                    <div class="row">
                        ...
                        <x-forms.text-input-component name="name" id="name" type="text" text="Name"
                            ...
                            placeholder="{{ __('Enter :value', ['value' => __('Position Name')]) }}">
