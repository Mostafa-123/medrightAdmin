            ...
            <div class="card radius-15">
                <div class="card-body">
                    <div class="card-title">
                        <h4 class="mb-0">{{ __('Positions') }}
                            @if(PerUser('positions.create'))
                        <a href="{{ route('positions.create') }}" style="float:right;" class="btn btn-primary ml-auto"><i class="fadeIn animated bx bx-message-square-add"></i> {{ __('Create :type',['type'=>__('Position')]) }}</a>
                    @endif
                        </h4>
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function (msg) {
                        window.LaravelDataTables["positions"].draw();
