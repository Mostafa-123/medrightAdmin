    ...
    */
    ...
    'canvas' => [
        'styles' => [
            ...
            'frontend/assets/css/style.ar.css',
            'frontend/assets/css/coustom.css',
            'frontend/assets/css/coustom.ar.css',

        ],
        'scripts' => [
            'frontend/assets/js/jquery-main.js',
            'frontend/assets/js/jquery-migrate.js',
            'frontend/assets/js/jquery-ui.min.js',
            'frontend/assets/js/modernizr.js',
            'frontend/assets/js/popper.min.js',
            'frontend/assets/js/bootstrap.min.js',
            'frontend/assets/js/plugincollection.js',
            ...
            'frontend/assets/js/validation-ar.js',
        ],
    ],
